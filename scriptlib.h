...
public:
	...
	//card lib
	static int32 card_get_card_registered(lua_State *L);
	...
	static int32 card_get_origin_country(lua_State *L);
	...
	static int32 duel_add_field_counter(lua_State *L);
	static int32 duel_remove_field_counter(lua_State *L);
